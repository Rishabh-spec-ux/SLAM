...
- every LiDAR hit point is drawn black on a white canvas
...
sequenceDiagram
    ...
    participant Loop as LoopClosureDetector
    ...
    Main->>Loop: register_and_detect(ekf_pose, measurements)
    Loop-->>Main: optional loop match
